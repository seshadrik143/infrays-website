...
const steps = [
  {
    ...
    desc: 'Sign up at the licensing portal — 15 days free, no credit card. You get an enrollment token immediately. Paste it into the server config; the server validates it against the issuer on startup and unlocks all features.',
    code: '$ curl -fsSL https://infrays.org/install.sh | sudo bash',
    output: '→ License accepted: trial, 15 days remaining ✓',
