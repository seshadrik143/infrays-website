...
const posts: Record<string, {
  ...
  'infrays-v1-launch': {
    ...
    body: [
      ...
      '## Why build this?',
      'Modern infrastructure monitoring is fragmented. Most teams run 5–8 separate tools, each with its own agent, its own storage, its own alerting logic, and its own billing. We built infraYS to collapse that into one coherent system — with a 12MB agent, < 30MB memory footprint, and an MIT license.',
      '## What shipped in v1.0',
      'The v1.0 release includes everything from the first heartbeat beat to enterprise compliance: 27 phases covering metrics collection, structured log ingestion, distributed tracing, continuous profiling with flame graphs, AI anomaly detection, predictive alerting, flap detection, synthetic monitoring, SLO tracking, cloud cost import, OIDC SSO, RBAC, AES-256 encryption, Vault integration, GDPR erasure, SOC2/ISO27001 compliance reports, a 67-plugin ecosystem, Terraform and Pulumi providers, and a fully managed SaaS mode with Stripe billing.',
      '## What\'s next',
      'v1.1 will focus on the hosted cloud offering — streamlining the onboarding flow and expanding global synthetic probe coverage. Community contributions are welcome. The codebase is MIT licensed.',
    ],
  },
